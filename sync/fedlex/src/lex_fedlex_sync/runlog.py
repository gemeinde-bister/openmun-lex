"""Run logging for fedlex-sync: console output plus one log file per run.
...
Layout::
    ...
    {store_root}/sync_logs/{YYYYMMDD-HHMMSS}_ch.log
...
def start_run_log(
    ...
    *,
    ...
    Args:
        ...
        source: Source tag for the file name (default ``ch``).
